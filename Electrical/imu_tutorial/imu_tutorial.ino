...
#define DECLINATION 5.11 // Declination (degrees) in Atlanta, GA --Might need to be -5.11 , might not even be right, calculation site was confusing

void setup() 
{
  Serial.begin(115200);// symbols/second
